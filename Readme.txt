...
-App data:
    ...
    -Default: It contains the default image to display and theme.

    -Demo:
	-AI Images: Folder that contains known AI made images for demo.
